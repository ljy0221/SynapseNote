...
import { NodeSelectorModal } from '../../components/features/mindmap/NodeSelectorModal'; // 모달 임포트
    ...
    return (
        <div className="page-content-container mindmap-page">
            <main className="mindmap-canvas-area" style={{ position: 'relative', height: '100%' }}>
                ...
                {isEditMode && (
                    <MindmapToolbar
                        onAdd={handleAddNodeClick} // 수정된 핸들러 연결
        ...
        <main className="mindmap-canvas-area" style={{ position: 'relative', height: '100%' }}>
            ...
            {isEditMode && (
                <MindmapToolbar
                    ...
                    onToggleDisconnectMode={toggleDisconnectMode}
                    isDisconnectMode={isDisconnectMode}
                    onAlign={handleAutoAlign} // [New] 핸들러 전달
                    isEditMode={isEditMode}
                />
            )}
